"""
Profile system for SimpleReconURL.

Profiles are defined in config/profiles.json and let users run predefined
source sets with optional default options (e.g. rate_limit).

Usage:
    python simplereconurl.py -u https://target.com/ --profile fast
    python simplereconurl.py -u https://target.com/ --profile discovery
